-- Adapted for Luajit by dinau, 2023/12
--
local ffi = require"ffi"
local lib = ffi.load"SDL2_ttf"

-- SDL_ttf : v2.20.2 (2023/12)
ffi.cdef[[
typedef struct {} FILE;
...
__index = function(t,k)
	local ok,ptr = pcall(function(str) return lib["TTF_"..str] end,k)
	...
	if not ok then --torch sdl2 calling
		local str2 = "TTF_"..string.upper(k:sub(1,1))..k:sub(2)
